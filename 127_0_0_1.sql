...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 12, 2019 at 10:55 PM
...
('', '', 0, '', 1, 0, '0000-00-00', 0, ''),
('Samer Alataona', 'Software Deployment', 56789, 'McAfee Install', 1, 444, '2019-01-12', 11, ''),
('Samer Alataona', 'Software Deployment', 56789, 'McAfee Install', 1, 444, '2019-01-12', 11, ''),
('Samer Alataona', 'Software Deployment', 56789, 'McAfee Install', 1, 444, '2019-01-06', 67, ''),
('Samer Alataona', 'Software Deployment', 56789, 'McAfee Install', 1, 444, '2019-01-06', 67, '');
...
(444, 'McAfee Install', 56789, 100, 444);
--
-- Database: `phpmyadmin`
--
...
('root', '[{\"db\":\"hourscharge\",\"table\":\"main\"},{\"db\":\"hourscharge\",\"table\":\"projects\"},{\"db\":\"hourscharge\",\"table\":\"tasks\"},{\"db\":\"hourscharge\",\"table\":\"employees\"},{\"db\":\"hourscharge\",\"table\":\"Main\"},{\"db\":\"hourscharge\",\"table\":\"Tasks\"},{\"db\":\"HoursCharge\",\"table\":\"Employees\"}]');
...
('root', '2019-01-12 19:01:39', '{\"Console\\/Mode\":\"collapse\"}');
