...
?>
    ...
    <body>
        ...
        <div class="container cntr1">
            ...
            <div class="comments">
                <div class="commentHead"><i class="far fa-comment"></i>Comments</div>
                <textarea id=comment></textarea>
            </div>
            <input type=button class="btn btn-primary" value="SAVE" onclick="saveData()">
            <input type="button" class="btn btn-primary" value="reports" onclick="showReport()">
            <div class="dttable">
                <div class="dtHeader">My Reports</div>
                <div class="filters">
                    <i class="fas fa-filter"></i>
                    <select id="projectsFilter" onchange="orderProject()">
                        <option value=""></option>
                        <?php
                              getOptions("Projects");
