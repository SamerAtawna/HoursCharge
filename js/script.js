function updateTasks() {//Update tasks according to selected project
...
function getRequests(user) {//Get requests per employee
...
function orderProject() {//Order reports according to project
...
function orderDate() {//Order reports according to date 
...
function showSuccess() {//show success message  
...
function saveData() {//Store inserted data into DB 
    $(".spinner").show();
